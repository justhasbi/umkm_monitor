...
INSERT INTO `laporan_item` (`item_id`, `price`, `terjual`, `sub_total`, `laporan_id`) VALUES
(9, 20000, 2, 40000, 1);
...
--
ALTER TABLE `outlet`
  MODIFY `outlet_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2214;
...
--
ALTER TABLE `laporan`
  ADD CONSTRAINT `laporan_ibfk_1` FOREIGN KEY (`outlet_id`) REFERENCES `outlet` (`outlet_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `laporan_item`
--
ALTER TABLE `laporan_item`
  ADD CONSTRAINT `laporan_item_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `p_item` (`item_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `laporan_item_ibfk_2` FOREIGN KEY (`laporan_id`) REFERENCES `laporan` (`laporan_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
